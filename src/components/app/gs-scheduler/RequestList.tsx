...
const RequestList: FC = () => {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      const response = await fetch(`/api/v1/request/${editingRequest.id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDelete = async (id: string) => {
    try {
      const response = await fetch(`/api/v1/request/${id}`, {
        method: "DELETE",
      });
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <SortableHeader label="Request Type" sortKey="requestType" />
            <SortableHeader label="Mission" sortKey="mission" />
            <SortableHeader label="Satellite" sortKey="satellite_name" />
        ...
        <TableBody>
          {sortedRequests.map((request) => (
            <TableRow key={request.id}>
              ...
              <TableCell>{formatValue(request.requestType)}</TableCell>
              <TableCell>{formatValue(request.mission)}</TableCell>
              <TableCell>{formatValue(request.satellite_name)}</TableCell>
              <TableCell>{formatValue(request.station_id, "number")}</TableCell>
              <TableCell>{formatValue(request.startTime, "date")}</TableCell>
              <TableCell>{formatValue(request.endTime, "date")}</TableCell>
              <TableCell>
                <Button
                  variant="outline"
                  size="sm"
        ...
        <DialogContent className="bg-white border shadow-lg max-h-[90vh] flex flex-col z-[1000]">
          ...
          {editingRequest && (
            <div className="grid gap-4 py-4 overflow-y-auto">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="satellite" className="text-right">
                  Satellite
                </Label>
                <div className="col-span-3 p-2 bg-gray-50 rounded">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.station_id, "number")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.orbit, "number")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.uplink, "boolean")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.telemetry, "boolean")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.science, "boolean")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.startTime, "date")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.endTime, "date")}
                </div>
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="col-span-3 p-2 bg-gray-50 rounded">
                  {formatValue(editingRequest.duration, "number")}
                </div>
              </div>
